...
class structRFMConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`structRFMModel`]. It is used to instantiate a RNA-FM
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 25):
            ...
            `inputs_ids` passed when calling [`structRFMModel`].

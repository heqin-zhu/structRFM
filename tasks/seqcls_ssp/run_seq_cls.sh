...
nohup python3 run_seq_cls.py --device 'cuda:7' --model_name structRFM --LM_path ${structRFM_checkpoint} --batch_size 8 --output_dir outputs_seqcls/lncRNA_H_1024 --dataset lncRNA_H_uni --max_seq_len 1024 > log_lncRNA_H_uni_1024 2>&1 &
